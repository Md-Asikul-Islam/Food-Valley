...
function OrderItems() {
  ...
  <div className="max-h-[300px] overflow-y-auto py-2 mb-3 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 hover:scrollbar-thumb-gray-500 transition-all duration-300 space-y-3">
    {foodItems.map((item) => (
      <div
        key={item.id}
      ...
      >
        ...
        <div className="flex items-center space-x-3 justify-end sm:justify-center">
          <button className="w-8 h-8 bg-gray-800 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors duration-300">
